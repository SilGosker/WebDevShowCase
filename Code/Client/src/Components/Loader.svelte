...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="{width}" height="{width}" style="shape-rendering: auto; display: block; background: rgba(0, 189, 248, 0);" xmlns:xlink="http://www.w3.org/1999/xlink"><g><circle fill="#00bdf8" r="10" cy="50" cx="84">
    ...
    <animate begin="0s" values="#00bdf8;#0284c7;#00bdf8;#0284c7;#00bdf8" keyTimes="0;0.25;0.5;0.75;1" calcMode="discrete" dur="3.2258064516129035s" repeatCount="indefinite" attributeName="fill"></animate>
</circle><circle fill="#00bdf8" r="10" cy="50" cx="16">
...
</circle><circle fill="#0284c7" r="10" cy="50" cx="50">
...
</circle><circle fill="#00bdf8" r="10" cy="50" cx="84">
...
</circle><circle fill="#0284c7" r="10" cy="50" cx="16">
